    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center text-white max-w-4xl px-4">
              ...
              <p className="text-xl md:text-2xl mb-8">
                Learn from the best coaches and judges in the cheerleading community
              </p>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Featured ICA Coaches</h2>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">ICA Certified Judges</h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Our experienced judges ensure fair and consistent scoring across all ICA competitions.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {judges.map((judge) => (
                <Card key={judge.id} className="text-center hover:shadow-lg transition-shadow">
                  <CardHeader>
                    <div className="mx-auto w-24 h-24 rounded-full overflow-hidden mb-4">
                      <Image
                    ...
                    <p className="text-red-600 font-medium">{judge.level}</p>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="text-sm text-gray-600">
                      <p>
                        <strong>Experience:</strong> {judge.experience}
                      </p>
                    </div>
                    <div className="flex flex-wrap justify-center gap-2">
