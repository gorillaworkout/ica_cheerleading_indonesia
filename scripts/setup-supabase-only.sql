-- Create profiles table (simplified for Supabase auth only)
...
-- Insert a default admin user (replace with your email after you sign up)
-- You'll need to update this after creating your account
